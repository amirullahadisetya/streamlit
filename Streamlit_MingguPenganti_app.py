...
st.subheader("Rata-rata Gaji Berdasarkan Gender")

salary_gender = (
    df_filtered
    .groupby("Gender")["AnnualSalary"]
    .mean()
    .reset_index()
)

bar_salary_gender = px.bar(
    salary_gender,
    x="Gender",
    y="AnnualSalary",
    title="Rata-rata Gaji Berdasarkan Gender"
)

st.plotly_chart(bar_salary_gender)
